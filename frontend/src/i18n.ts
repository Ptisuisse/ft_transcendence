export const translations = {
  fr: {
    ...
    lvanSluContrib1: "UI/UX design (responsive, moderne, accessible)",
    lvanSluContrib2: "Développement backend Node.js, SQLite",
    lvanSluContrib3: "Intégration de la blockchain Avalanche",
    lvanSluContrib4: "Mise en place de Prometheus & Grafana",
    lvanSluContrib5: "Compatibilité multi-navigateurs et traductibilité",
    lvanSluContrib6: "Infrastructure Docker",
    //LoginPage
  ...
  en: {
    ...
    lvanSluContrib1: "UI/UX design (responsive, modern, accessible)",
    lvanSluContrib2: "Backend development (Node.js, SQLite)",
    lvanSluContrib3: "Avalanche blockchain integration",
    lvanSluContrib4: "Prometheus & Grafana setup",
    lvanSluContrib5: "Multi-browser compatibility & translation support",
    lvanSluContrib6: "Docker infrastructure & service orchestration",
  ...
  es: {
    ...
    lvanSluContrib1: "Diseño UI/UX (responsive, moderno, accesible)",
    lvanSluContrib2: "Desarrollo backend (Node.js, SQLite)",
    lvanSluContrib3: "Integración de blockchain Avalanche",
    lvanSluContrib4: "Implementación de Prometheus & Grafana",
    lvanSluContrib5: "Compatibilidad multi-navegador y soporte de traducción",
    lvanSluContrib6: "Infraestructura Docker y orquestación de servicios",
    //LoginPage
