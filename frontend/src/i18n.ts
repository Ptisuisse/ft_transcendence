export const translations = {
  ...
  en: {
    ...
    pirulencContrib1: "Faithful implementation of the original Pong game.",
    pirulencContrib2: "Creation of a multiplayer version.",
    pirulencContrib3: "Full customization of all games.",
    pirulencContrib4: "Implementation of an AI.",
    pirulencContrib5: "Creation of a tournament system with matchmaking.",
    pirulencContrib6: "Game mechanics management depending on the platform.",
    //LoginPage
